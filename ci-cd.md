...
> **Scope**: GitHub Actions workflows for Claude Code @mention triggers and standard quality gates
> **Prerequisites**: [Python Tooling](python-tooling.md), [Testing Strategy](testing-strategy.md)
> **Deliverables**: `.github/workflows/claude.yml` and `.github/workflows/ci.yml` configured
> **Estimated effort**: XS
